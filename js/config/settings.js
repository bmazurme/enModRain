  // settings.editForm - '.form_type_edit'
  // settings.inputName - '.inbox__input_name'
  // settings.inputAddress - '.inbox__input_address'
  // settings.removeButton - '.button_remove'
  // settings.editButton - '.button_edit'
